...
-- Screenshots
hl.bind(mainMod .. " + CTRL + S", hl.dsp.exec_cmd("hyprshot -m output --freeze --clipboard-only"))
hl.bind(mainMod .. " + CTRL + W", hl.dsp.exec_cmd("hyprshot -m window --freeze --clipboard-only"))
hl.bind(mainMod .. " + CTRL + R", hl.dsp.exec_cmd("hyprshot -m region --freeze --clipboard-only"))

-- Color picker
hl.bind(mainMod .. " + CTRL + C", hl.dsp.exec_cmd("hyprpicker"))

-- Hyprlock (lock computer)
